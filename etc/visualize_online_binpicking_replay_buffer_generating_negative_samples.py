...
if __name__ == "__main__":
    ...
    path_save = "/home/jih3le/panda_ws/src/eval_new_0707_test"
    
    for idx in range(len(eval_replay_memory)):
        online_batch, indexes = train_replay_memory.sample(batch_size=batch_size)
        online_obs, online_action, online_reward, online_obs_next, online_done, _ = online_batch

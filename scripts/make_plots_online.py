...
# logdir = f"/home/leh2rng/work_logs/pes"
# logdir = f"/home/leh2rng/work_logs/cirriculum/noweighted"
# logdir = f"/home/leh2rng/work_logs/cirriculum/freematch/softmax" #softmax
# save_dir = f"/home/leh2rng/work_logs/cirriculum/freematch"
# logdir = f"/home/leh2rng/work_logs/cirriculum/flexmatch/softmax" #softmax
# save_dir = f"/home/leh2rng/work_logs/cirriculum/flexmatch"
logdir = f"/home/leh2rng/work_logs/pes" #softmax
save_dir = f"/home/leh2rng/work_logs/"
weight = 0.8
    ...
    if os.path.isdir(current_log_path):
        ...
        if args['w_online'] == 1 and args['w_pseudo'] == 0 and args['w_offline'] == 0:
            ...
            if args['ssl_method'] == "fixmatch":
                ...
                method = f"{args['ssl_method']}_D{args['pseudo_samples']}_L{args['ssl_lower_confidence']}"
                ...
                for value in event.summary.value:
                    if value.HasField('simple_value'):
                        if value.tag in tags:
                            ...
                            log_data.append({**modified_args, 'step': event.step, 'tag': value.tag, 'value': value.simple_value, 'smoothed_value': smoothed_value, 'method': method})
